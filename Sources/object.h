...
// These are different from Lox functions.
// When they are called, they don't push a CallFrame, because
// there's no bytecode code for that frame to point to.
// They have no bytecode chunk.
